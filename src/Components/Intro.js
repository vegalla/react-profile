    ...
    return (
        <div className={styles.main}>
            ...
            <div className={styles.summary}>
                <p>
                    Stemming from his family's history with the Navy, Vince is impassioned towards public interest techology and advancing modernization at all levels of government. Stories of IT modernization such as <a href="https://aws.amazon.com/blogs/publicsector/helping-agencies-improve-customer-experience-benefits-eligibility-enrollment/">state unemployment shifting to the cloud with AWS</a> to cases described by <a href="https://www.newamerica.org/pit/power-to-the-public-the-promise-of-public-interest-technology/">Hana Schank and Tara Dawson McGuinness' book <i>Power to the Public</i></a>, galvanize Vince towards continuous learning with technologies from machine learning to cloud development.
                </p>
            </div>
        </div>
    )
